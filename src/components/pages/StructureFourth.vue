<template>
  <div class="structure">
    ...
    <div class="main">
      ...
      <div class="structureNameStyle"  v-for="(structureName,index) in structureList" @click="fifthStructure(structureName)" :key="index">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fifthStructure: function(ind){
        let strName = ind;
        let id = strName.id;
        let name = strName.departmentName;
        this.$router.push({name: 'structureFifth',
