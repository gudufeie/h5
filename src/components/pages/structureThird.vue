<template>
  <div class="structure">
    ...
    <div class="main">
      ...
      <div class="structureNameStyle"  v-for="(structureName,index) in structureList" @click="fourStructure(structureName)">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fourStructure: function(ind){
        let strName = ind;
        let id = strName.id;
        let name = strName.departmentName;
        this.$router.push({name: 'structureFourth',
